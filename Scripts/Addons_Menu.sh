...
case $opt in 
	1 ) echo -e "${GREEN}Add the 'box' user.${WHITE}"
		cp Addons_Proot_Add_user.sh $PROOT_ROOT/Addons_Proot_Add_user.sh
	...
	2 ) echo -e "${GREEN}Set up Bash x86 and x64.${WHITE}"
		cp Addons_Proot_Box86_64_Bash.sh $PROOT_ROOT/Addons_Proot_Box86_64_Bash.sh
	...
	3 ) echo -e "${GREEN}Install Steam...${WHITE}"
		cp Addons_Proot_Add_user.sh $PROOT_ROOT/Addons_Proot_Add_user.sh
		cp Addons_Proot_Box86_64_Bash.sh $PROOT_ROOT/Addons_Proot_Box86_64_Bash.sh
		cp Addons_Proot_Steam.sh $PROOT_ROOT/Addons_Proot_Steam.sh
		chmod +x $PROOT_ROOT/Addons_Proot_Add_user.sh
		chmod +x $PROOT_ROOT/Addons_Proot_Box86_64_Bash.sh
	...
	4 ) echo -e "${GREEN}Adding tur-repo and install mesa-zink...${WHITE}"
	    chmod +x Addons_Termux_Mesa_Zink_VirGL.sh
		./Addons_Termux_Mesa_Zink_VirGL.sh
		exit;;
	5 ) echo -e "${GREEN}Set up Bash x86 and x64.${WHITE}"
		cp Addons_Proot_GL4ES.sh $PROOT_ROOT/Addons_Proot_GL4ES.sh
